...
void Node::makeThisCopy(Node *original) {    //Função que copia um nó
...
/*****************************************\
|*** Funções que "nullam" os ponteiros ***|
\*****************************************/
...
void Node::null_Lpointer() {
    if (left) delete left;
    left = NULL;
}

void Node::null_Rpointer() {
